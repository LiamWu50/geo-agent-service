        ...
        payload_messages = [
            {
                ...
                "content": (
                    ...
                    "For executed GIS operations, final answers may cite resultDatasetId, "
                    "toolCallId, bbox, area, featureCount, geometryType, dataRef, and lineage "
                    "only when those exact values appear in tool.completed.output. "
